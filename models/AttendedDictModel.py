...
class AttendDictConfig(object):
    ...
    def from_dict(cls, json_object):
        ...
        config = AttendDictConfig(vocab_size=None)
...
class AttendDictModel(object):
    ...
    def __init__(self, config: AttendDictConfig, is_training,
